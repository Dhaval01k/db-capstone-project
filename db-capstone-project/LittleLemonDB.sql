...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `CustomerID_FK` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomersID`),
...
CREATE TABLE `orderdeliverystatus` (
  ...
  CONSTRAINT `OrderIDO_FK` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`),
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `MenuID_FK` FOREIGN KEY (`MenuID`) REFERENCES `menus` (`MenusID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-24 16:07:12
